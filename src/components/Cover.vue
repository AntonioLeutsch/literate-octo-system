<template>
  <div class="bg-zinc-900">
      ...
      >
        <div class="flex lg:flex-1">
          <RouterLink to="/" class="-m-1.5 p-1.5">
            <span class="sr-only">Webwirtschaft</span>
            <Logo class="h-12 w-auto fill-emerald-500" />
          </RouterLink>
        </div>
      ...
      >
        ...
        >
          <div class="flex items-center justify-between">
            <RouterLink to="/" class="-m-1.5 p-1.5">
              <span class="sr-only">Webwirtschaft</span>
              <Logo class="h-8 w-auto fill-emerald-500" />
            </RouterLink>
            <button
              type="button"
    ...
    <div class="relative isolate overflow-hidden pt-14">
      <div class="absolute inset-0 -z-10 h-full w-full bg-emerald-900"></div>
      <img
        src="https://webwirtschaft.net/wp-content/uploads/webmontag.jpg"
        alt=""
      ...
      >
        <div
          class="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#f6ff80] to-[#d3fc89] opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          style="
            clip-path: polygon(
              74.1% 44.1%,
              100% 61.6%,
      ...
      <div class="mx-auto max-w-xl py-32 sm:py-48 lg:py-56">
        <div class="hidden sm:mb-8 sm:flex sm:justify-center">
          <div
            class="relative rounded-full px-3 py-1 text-sm leading-6 text-zinc-300 ring-1 ring-white/25 hover:ring-white/50"
          >
            Jeden letzen Montag im Monat!
            <a href="#" class="font-semibold text-white"
              ><span class="absolute inset-0" aria-hidden="true" />Mehr erfahren
        ...
        <div class="text-center">
          ...
          <p class="mt-6 text-lg leading-8 text-zinc-200">
            Den Blick über den eigenen Telelerand hinaus bekommen und Austausch
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            ...
            >
            <a href="#" class="text-sm font-semibold leading-6 text-white"
              >Weitere Events <span aria-hidden="true">→</span></a
            >
          </div>
        </div>
      </div>
